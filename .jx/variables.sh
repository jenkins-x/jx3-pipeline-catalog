...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx3-pipeline-catalog/master/309'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx3-pipeline-catalog:0.6.28'
