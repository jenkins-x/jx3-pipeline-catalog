...
export BUILD_NUMBER='483'
export DOCKERFILE_PATH='Dockerfile'
export DOCKER_REGISTRY='ghcr.io'
export DOCKER_REGISTRY_ORG='jenkins-x'
export DOMAIN='infra.jenkins-x.rocks'
export GIT_BRANCH='master'
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx3-pipeline-catalog/master/483'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx3-pipeline-catalog:1.3.152'
