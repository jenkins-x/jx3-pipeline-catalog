...
export BUILD_NUMBER='687'
export DOCKERFILE_PATH='Dockerfile'
export DOCKER_REGISTRY='ghcr.io'
export DOCKER_REGISTRY_ORG='jenkins-x'
export DOMAIN='infra.jenkins-x.rocks'
export GIT_BRANCH='master'
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx3-pipeline-catalog/master/687'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx3-pipeline-catalog:1.5.51'
